...
class PremiumGuild:
    ...
    def __init__(self, db, document=None):
        ...
        # Load data if document is not None provided
    ...
    async def save(self):
        ...
        try:
            ...
            if self._id is not None:
                ...
                # Insert new document
                result = await self.db.premium_guilds.insert_one(data)
...
class PremiumServer:
    ...
    def _load_from_document(self, document):
        ...
        if sftp_enabled_raw is not None:
            ...
            if isinstance(sftp_enabled_raw, bool):
        ...
        if historical_parse_done_raw is not None:
            # Handle various values that could represent "true"
            if isinstance(historical_parse_done_raw, bool):
