...
class Bounty(BaseModel):
    ...
    async def create_bounty(
        ...
        bounty = cls(
            ...
            created_at=now,
            updated_at=now,
            requirement=requirement if requirement is not None else {}
        )
    ...
    async def get_player_stats_for_bounty(
        ...
        async for doc in cursor:
            ...
            for victim in doc.get("victims", []):
                if isinstance(victim, dict) and victim["kill_count"] >= repeat_threshold:
                    meets_fixation = True
                    if isinstance(victim, dict) and victim["kill_count"] > target_fixation:
