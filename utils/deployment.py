...
class DeploymentManager:
    ...
    async def prepare_deployment(self) -> bool:
        ...
        if self.bot and hasattr(self.bot, 'system_monitor'):
            ...
            if isinstance(SYSTEM_HEALTH, dict) and SYSTEM_HEALTH["status"] == HEALTH_CRITICAL:
            ...
            if isinstance(SYSTEM_HEALTH, dict) and SYSTEM_HEALTH["status"] == HEALTH_DEGRADED:
